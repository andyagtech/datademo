...
TABLE_PAIRS: list[_TablePairConfig] = [
    ...
    },
    {
        ...
        "numeric_cols": [
            ...
            "LINE_COINSRNC_AMT_4", "LINE_COINSRNC_AMT_5",
            "LINE_ALOWD_CHRG_AMT_1", "LINE_ALOWD_CHRG_AMT_2", "LINE_ALOWD_CHRG_AMT_3",
            "LINE_ALOWD_CHRG_AMT_4", "LINE_ALOWD_CHRG_AMT_5",
        ],
    },
]
